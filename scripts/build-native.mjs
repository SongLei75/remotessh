...
const wolfSource = process.env.WOLFSSH_SOURCE || resolve(root, '../wolf/wolfssh');
const sslSource = process.env.WOLFSSL_SOURCE || resolve(root, '../wolf/wolfssl');
copyFileSync(join(wolfSource, 'LICENSING'), join(artifacts, 'wolfSSH-LICENSING'));
copyFileSync(join(sslSource, 'COPYING'), join(artifacts, 'wolfSSL-COPYING'));
